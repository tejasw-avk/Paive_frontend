...
export default function AppQuestions() {
    ...
    const pageRoutes = {
        "Site Location": "/appQuestions/siteLocation",
        "Application Details": "/appQuestions/appDetails",
        "Description of Proposed Works": "/appQuestions/proposedWork",
        "Site Information": "/appQuestions/siteInfo",
        "Further information about proposed development": "/appQuestions/pwYes",
        "Development Dates": "/appQuestions/devDates",
        "Materials": "/appQuestions/materialQues",
        "Trees and Hedges": "/appQuestions/treeshedges",
        "Pedestrian and Vehicle Access, roads and rights of way": "/appQuestions/pedQues",
        "Vehicle parking": "/appQuestions/vehParking",
        "Biodiversity Net Gain": "/appQuestions/bngQues",
        "Site visit": "/appQuestions/siteVisit",
        "Pre-application advice": "/appQuestions/preAdvice",
        "Authority Employee/Member": "/appQuestions/empAuthority",
        "Certificates": "/appQuestions/ownerCert",
    };
